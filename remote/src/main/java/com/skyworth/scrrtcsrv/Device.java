...
import com.skyworth.scrrtcsrv.wrappers.ClipboardManager;
import com.skyworth.scrrtcsrv.wrappers.InputManager;
import com.skyworth.scrrtcsrv.wrappers.ServiceManager;
import com.skyworth.scrrtcsrv.wrappers.SurfaceControl;
import com.skyworth.scrrtcsrv.wrappers.WindowManager;
...
public final class Device {
    ...
    public Point getPhysicalPoint(Position position) {
        ...
        if (!unlockedVideoSize.equals(clientVideoSize)) {
            ...
            Ln.e("unmatched video size: " + unlockedVideoSize + " " + clientVideoSize);
            return null;
        }

package com.sdt.diagnose.Device.X_Skyworth.App.PermissionControl.model;
...
import com.sdt.diagnose.Device.X_Skyworth.App.PermissionControl.utils.ArrayUtils;
...
public final class AppPermissionGroup implements Comparable<AppPermissionGroup> {
    ...
    private AppPermissionGroup(Context context, PackageInfo packageInfo, String name,
        ...
        if (iconResId != 0) {
            ...
            mIconResId = R.drawable.ic_launcher_foreground;
        }

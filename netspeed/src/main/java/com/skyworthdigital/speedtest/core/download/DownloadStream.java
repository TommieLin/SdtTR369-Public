package com.skyworthdigital.speedtest.core.download;
...
public abstract class DownloadStream {
    ...
    public DownloadStream(String server, String path, int ckSize, String errorHandlingMode,
            int connectTimeout, int soTimeout, int recvBuffer, int sendBuffer, Logger log) {
        this.server = server;
        this.path = path;
        this.ckSize = ckSize;
                ...
                try {
                    ...
                    downloader = new Downloader(c, path, ckSize) {
                        ...
                        public void onError(String err) {
                            ...
                            if (errorHandlingMode.equals(SpeedTestConfig.ONERROR_ATTEMPT_RESTART)
                                    || errorHandlingMode.equals(
